...
class _$CategoryImpl implements _Category {
  ...
  @override
  String toString() {
    return 'Category(id: $id, title: $title, description: $description, imageUrl: $imageUrl, eventsCount: $eventsCount)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, imageUrl, eventsCount);
...
abstract class _Category implements Category {
  factory _Category(
      ...
      required final int eventsCount}) = _$CategoryImpl;
